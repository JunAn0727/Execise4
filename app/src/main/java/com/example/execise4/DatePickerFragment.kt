...
class DatePickerFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onDateSet(view: DatePicker, year: Int, month: Int, day: Int) {
        ...
        activity.findViewById<TextView>(R.id.text_view_1).text ="Minimum Basic Saving: RM$minBasicSaving"
        activity.findViewById<TextView>(R.id.text_view_2).text ="Allowable Investment Amount: RM" + df.format(allowableInvestAmount)
        when {
            age>=90 -> {
                Toast.makeText(
                    activity,
